...
function askPlayerName() {
    ...
    if (playerName && playerName.trim() !== "") {
        ...
        // Use player's name
        document.querySelectorAll('#playerName').forEach(function(element) {
        ...
        // If the user didn't enter a name, ask again
        alert("You need to enter a name to start the game.");
        askPlayerName(); 
    }
}
...
function initialize() {
    ...
    // ADDED PLAYER NAME PROMPT
    askPlayerName();
    // SOLUTION REMOVED THE TIMER THAT WOULD SHOUW THE POPUP AGAIN
...
function endGame(who) {
    ...
    if (who == player) {
        announceWinner("Congratulations, " + playerName + "! You won!");
